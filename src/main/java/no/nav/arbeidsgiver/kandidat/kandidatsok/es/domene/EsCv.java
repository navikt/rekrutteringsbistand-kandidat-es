...
public class EsCv {
    ...
    private String veilederVisningsnavn;
    ...
    public EsCv(
            ...
            String veilederVisningsnavn,
            String veilederEpost,
            String fylkeNavn,
            String kommuneNavn
    ) {
        ...
        this.veileder = veilederIdent == null ? null : veilederIdent.toLowerCase();
        this.veilederIdent = veilederIdent == null ? null : veilederIdent.toLowerCase();
        this.veilederVisningsnavn = veilederVisningsnavn;
        this.veilederEpost = veilederEpost;
    ...
    public String getVeilederVisningsnavn() {
        return veilederVisningsnavn;
    }

    public String getVeilederEpost() {
        return veilederEpost;
    }
