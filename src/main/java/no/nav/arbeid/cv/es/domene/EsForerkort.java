...
public class EsForerkort {
  ...
  public EsForerkort(Date fraDato, Date tilDato, String forerkortKode,
      String forerkortKodeKlasse, String alternativKlasse, String utsteder) {
  ...
  public int hashCode() {
    ...
    return Objects
        .hash(fraDato, tilDato, forerkortKode, forerkortKodeKlasse, alternativKlasse, utsteder);
  }
  ...
  public String toString() {
    return "EsForerkort{" +
        "fraDato=" + fraDato +
        ", tilDato=" + tilDato +
        ", forerkortKode='" + forerkortKode + '\'' +
        ", forerkortKodeKlasse='" + forerkortKodeKlasse + '\'' +
        ", alternativKlasse='" + alternativKlasse + '\'' +
        ", utsteder='" + utsteder + '\'' +
        '}';
  }
