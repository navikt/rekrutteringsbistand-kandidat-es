...
public class EsCvObjectMother {
  ...
  public static EsCv giveMeEsCvIkkeTemp() {
    ...
    EsUtdanning EsUtdanning = new EsUtdanning(d("1988-08-20"), d("1989-06-20"), "Otta vgs. Otta",
    ...
    EsYrkeserfaring yrkeserfaring4 =
        new EsYrkeserfaring(d("2005-08-01"), d("2016-07-01"), "Vard Group,avd.Brevik", "7233.03",
            "Industrimekaniker", "Industrimekaniker", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring5 =
        new EsYrkeserfaring(d("2016-06-01"), d("2017-04-01"), "MTM anlegg", "8332.03",
    ...
    EsKompetanse kompetanse1 =
        new EsKompetanse(d("2016-03-14"), "3020813", "Maskin- og kranførerarbeid", null, null);
    ...
    EsKurs kurs1 =
        new EsKurs(d("2012-12-01"), null, "Akseloppretting", "Easy-Laser", null, null, null);
    ...
    EsCv esCv = new EsCv("01016012345", "OLA", "NORDMANN", d("1960-01-01"), false, "ARBS",
        "unnasluntrer@mailinator.com", "NO", 1L, "CV51953", "", "J", d("2016-05-30"), "Minvei 1",
        "", "", "0654", "OSLO", "NO", 301, false, new Date());
  ...
  public static EsCv giveMeEsCv() {
    ...
    EsUtdanning utdanning1 = new EsUtdanning(d("1988-08-20"), d("1989-06-20"), "Høyskolen i Gjøvik",
        "786595", "Master i sikkerhet", "Master i sikkerhet");
    ...
    EsYrkeserfaring yrkeserfaring4 =
        new EsYrkeserfaring(d("2005-08-01"), d("2005-09-01"), "Vard Group,avd.Brevik", "7233.03",
            "Industrimekaniker", "Industrimekaniker", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring5 =
        new EsYrkeserfaring(d("2016-06-01"), d("2016-07-01"), "MTM anlegg", "8332.03",
            "Lastebil- og trailersjåfør", "Sjåfør kl. 2", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring6 =
        new EsYrkeserfaring(d("2017-10-01"), d("2017-12-01"), "NLI  Grenland", "7233.03",
            "Industrimekaniker", "Industrimekaniker", "YRKE_ORGNR", "YRKE_NACEKODE", false);
    ...
    EsKompetanse kompetanse3 = new EsKompetanse(d("2016-03-14"), "506", "Landtransport generelt",
    ...
    EsVerv verv = new EsVerv(d("2000-01-15"), d("2001-01-15"), "Verv organisasjon", "verv tittel");
    ...
    EsGeografiJobbonsker geografiJobbonsker1 = new EsGeografiJobbonsker("Lillehammer", "NO10.1011");
    ...
    ArrayList<EsAnsettelsesforholdJobbonsker> ansettelsesforholdJobbonskerListe = new ArrayList<>();
    ...
    ArrayList<EsArbeidstidsordningJobbonsker> arbeidstidsordningJobbonskerListe = new ArrayList<>();
    arbeidstidsordningJobbonskerListe.add(arbeidstidsordningJobbonsker);

    EsCv esCv = new EsCv("01016012345", "OLA", "NORDMANN", d("1960-01-01"), false, "ARBS",
        "unnasluntrer@mailinator.com", "NO", 1L, "S221234", // Kan ik
        "", "N", d("2016-05-30"), "Minvei 1", "", "", "0654", "OSLO", "NO", 301, false, new Date());
  ...
  public static EsCv giveMeEsCv2() {
    ...
    EsYrkeserfaring yrkeserfaring1 =
        new EsYrkeserfaring(d("2000-01-01"), d("2002-01-01"), "Kodesentralen Vardø", "5746.07",
    ...
    EsYrkeserfaring yrkeserfaring4 =
        new EsYrkeserfaring(d("2005-08-01"), d("2006-07-01"), "lagerarbeiderne L. H.", "8659.03",
            "Lagermedarbeider", "Lagermedarbeider", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring5 =
        new EsYrkeserfaring(d("2016-06-01"), d("2017-04-01"), "lagerarbeiderne L. H.", "8659.03",
            "Truckfører lager", "Stortruck", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring6 = new EsYrkeserfaring(d("2017-10-01"), null, "Awesome coders AS",
    ...
    EsKompetanse kompetanse2 = new EsKompetanse(d("2016-03-14"), "265478", "Programvareutvikler",
        "Programvareutvikler", null);

    EsKompetanse kompetanse3 =
        new EsKompetanse(d("2016-03-14"), "475136", "Lagermedarbeider", "Lagermedarbeider", null);
    ...
    EsGeografiJobbonsker geografiJobbonsker1 = new EsGeografiJobbonsker("Stavanger", "NO21.2020");
    ...
    EsCv esCv = new EsCv("05236984567", "KARI", "NORDMANN", d("1980-02-10"), false, "ARBS",
        "unnasluntrer2@mailinator.com", "NO", 2L, "H738234", "", "J", d("2016-05-30"), "Dinvei 2",
        "", "", "1337", "HUSKER IKKE", "NO", 301, false, new Date());
  ...
  public static EsCv giveMeEsCv3() {
    ...
    utdanningListe.add(EsUtdanning);
    EsYrkeserfaring yrkeserfaring1 =
        new EsYrkeserfaring(d("2000-01-01"), d("2000-02-01"), "Butikken i nærheten", "1010.01",
    ...
    EsYrkeserfaring yrkeserfaring4 = new EsYrkeserfaring(d("2005-08-01"), d("2005-09-01"),
        "Butikken", "4561.03", "Butikkmedarbeider(elektronikk)", "Butikkmedarbeider(elektronikk)",
        "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring5 = new EsYrkeserfaring(d("2016-06-01"), d("2016-07-01"),
        "Tvkanalen TV?", "5684.05", "Presentør", "Presentør", "YRKE_ORGNR", "YRKE_NACEKODE", false);
    ...
    EsKompetanse kompetanse1 = new EsKompetanse(d("2016-03-14"), "152424", "Presentør", null, null);

    EsKompetanse kompetanse2 =
        new EsKompetanse(d("2016-03-14"), "152424", "Nyhetsanker", "Nyhetsanker", null);

    EsKompetanse kompetanse3 =
        new EsKompetanse(d("2016-03-14"), "566895", "Butikkmedarbeider", "Butikkmedarbeider", null);
    ...
    EsForerkort forerkort4 =
        new EsForerkort(d("1996-02-01"), d("2020-12-01"), "V1.6145", "Traktorlappen", null, "");
    ...
    EsCv esCv = new EsCv("04265983651", "HANS", "NORDMANN", d("1955-11-04"), false, "ARBS",
        "alltidmed@mailinator.com", "NO", 3L, "S738893", "", "J", d("2016-05-30"), "Minvei 1", "",
        "", "2323", "INGEBERG", "NO", 301, false, new Date());
    esCv.addUtdanning(utdanningListe);
    esCv.addYrkeserfaring(yrkeserfaringListe);
    esCv.addKompetanse(kompetanseListe);
    esCv.addSertifikat(EsSertifikatListe);
  ...
  public static EsCv giveMeEsCv4() {
    ...
    ArrayList<EsUtdanning> utdanningListe = new ArrayList<>();
    utdanningListe.add(EsUtdanning);
    EsYrkeserfaring yrkeserfaring1 = new EsYrkeserfaring(d("2000-01-01"), d("2002-01-01"), "Jokah",
        "1010.01", "Butikkmedarbeider", "Butikkmedarbeider", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring2 = new EsYrkeserfaring(d("2003-01-01"), d("2003-04-01"),
        "Nærbutikkern", "1010.01", "Butikkmedarbeider(klesbutikk)", "Butikkmedarbeider(klebutikk)",
        "YRKE_ORGNR", "YRKE_NACEKODE", false);
    ...
    EsYrkeserfaring yrkeserfaring4 =
        new EsYrkeserfaring(d("2005-08-01"), d("2016-07-01"), "Vard Group,avd.Brevik", "5684.05",
    ...
    EsYrkeserfaring yrkeserfaring5 = new EsYrkeserfaring(d("2016-06-01"), d("2017-04-01"),
        "DN teater", "5124.46", "Skuespiller", "Skuespiller", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring6 = new EsYrkeserfaring(d("2017-10-01"), null,
        "Dukketeateret Rena", "5124.46", "Skuespiller(dukketeater)", "Skuespiller(dukketeater)",
        "YRKE_ORGNR", "YRKE_NACEKODE", false);
    ...
    EsKompetanse kompetanse1 = new EsKompetanse(d("2016-03-14"), "152424", "Hallovert", null, null);
    ...
    EsSertifikat EsSertifikat2 =
        new EsSertifikat(d("1991-01-01"), null, "V1.6090", "Førerkort: Kl. M (Moped)", null, "");
    ...
    EsGeografiJobbonsker geografiJobbonsker1 = new EsGeografiJobbonsker("Akershus", "NO02.1210");
    ...
    EsCv esCv = new EsCv("09568410230", "HANNE", "NORDMANN", d("2002-06-04"), false, "ARBS",
        "erjegmed@mailinator.com", "NO", 4L, "K838829", "", "J", d("2016-05-30"), "Noensvei 1", "",
        "", "7012", "TRONDHEIM", "NO", 301, false, new Date());
    esCv.addUtdanning(utdanningListe);
    esCv.addYrkeserfaring(yrkeserfaringListe);
    esCv.addKompetanse(kompetanseListe);
    esCv.addSertifikat(EsSertifikatListe);
  ...
  public static EsCv giveMeEsCv5() {
    ...
    EsYrkeserfaring yrkeserfaring1 =
        new EsYrkeserfaring(d("2000-01-01"), d("2000-02-01"), "Bankhvelvet BBL", "4865.75",
            "Bankhvelvoperatør", "Bankhvelvoperatør", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring2 = new EsYrkeserfaring(d("2003-01-01"), d("2003-02-01"),
        "Proggehula", "5746.07", "Progger", "Progger", "YRKE_ORGNR", "YRKE_NACEKODE", false);
    ...
    EsYrkeserfaring yrkeserfaring5 =
        new EsYrkeserfaring(d("2016-06-01"), d("2016-06-02"), "Lang transport A.S.", "8332.03",
            "Lastebil- og trailersjåfør", "Sjåfør kl. 3", "YRKE_ORGNR", "YRKE_NACEKODE", false);

    EsYrkeserfaring yrkeserfaring6 =
        new EsYrkeserfaring(d("2017-10-01"), d("2017-11-01"), "Mekken mekk", "7233.03",
            "Industrimekaniker", "Industrimekaniker", "YRKE_ORGNR", "YRKE_NACEKODE", false);
    ...
    EsCv esCv = new EsCv("03050316895", "BOB", "NORDMANN", d("1964-09-01"), false, "ARBS",
        "bobob@mailinator.com", "NO", 5L, "N883773", "", "J", d("2016-05-30"), "Minvei 90", "", "",
        "0565", "OSLO", "NO", 301, false, new Date());
    esCv.addUtdanning(utdanningListe);
    esCv.addYrkeserfaring(yrkeserfaringListe);
    esCv.addKompetanse(kompetanseListe);
    esCv.addSertifikat(EsSertifikatListe);
