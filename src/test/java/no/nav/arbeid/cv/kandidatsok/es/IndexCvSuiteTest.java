...
public class IndexCvSuiteTest {
  ...
  public void testFlereInputFritekstGirBredereResultat() throws IOException {
    Sokeresultat sokeresultat1 = sokClient.sok(Sokekriterier.med().fritekst("javautvikler").bygg());
    Sokeresultat sokeresultat =
        sokClient.sok(Sokekriterier.med().fritekst("industrimekaniker javautvikler").bygg());
  ...
  public void testSokPaNorskeStoppordGirIkkeResultat() throws IOException {
    Sokeresultat sokeresultatYrke =
        sokClient.sok(Sokekriterier.med().stillingstitler(Collections.singletonList("og")).bygg());
    Sokeresultat sokeresultatKomp =
        sokClient.sok(Sokekriterier.med().kompetanser(Collections.singletonList("og")).bygg());
    Sokeresultat sokeresultatUtdanning =
        sokClient.sok(Sokekriterier.med().utdanninger(Collections.singletonList("og")).bygg());
    Sokeresultat sokeresultatFritekst = sokClient.sok(Sokekriterier.med().fritekst("og").bygg());
  ...
  public void testStemOrdSkalGiSammeResultat() throws IOException {
    ...
    Sokeresultat sokeresultatStemOrd = sokClient
        .sok(Sokekriterier.med().stillingstitler(Collections.singletonList("Progg")).bygg());
  ...
  public void testSokPaFlereStyrkKoderGirBegrensendeResultat() throws IOException {
    ...
    Sokeresultat sokeresultat = sokClient.sok(Sokekriterier.med().styrkKoder(styrkKoder).bygg());
  ...
  public void testSokPaFlereNusKoderGirBegrensendeResultat() throws IOException {
    ...
    Sokeresultat sokeresultatToKoder = sokClient.sok(Sokekriterier.med().nusKoder(nusKoder).bygg());
  ...
  public void sokPaFlereUtdanningsnivaSkalGiFlereResultat() throws IOException {
    ...
    Sokeresultat sokeresultat1 = sokClient
  ...
  public void sokPaIngenUtdanningSkalGiKorrektResultat() throws IOException {
    ...
    Sokeresultat sokeresultatIngenOgGrunnskole =
        sokClient.sok(Sokekriterier.med().utdanningsniva(Arrays.asList("Ingen", "Master")).bygg());
