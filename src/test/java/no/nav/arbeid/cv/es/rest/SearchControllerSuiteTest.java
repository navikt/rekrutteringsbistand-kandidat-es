...
*/
    ...
    public void setUp() throws IOException {
        this.mockMvc = MockMvcBuilders.webAppContextSetup(this.context).addFilter(oidcTokenValidationFilter)
    ...
    public void fritekstSokUtenParametreSkalReturnereAlt() throws Exception {
        ...
        this.mockMvc.perform(get("/rest/kandidatsok/sok?fritekst=").accept(MediaType.APPLICATION_JSON)
