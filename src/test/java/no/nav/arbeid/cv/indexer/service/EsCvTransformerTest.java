...
import no.nav.arbeid.cv.indexer.domene.CvEventObjectMother;
import no.nav.arbeid.cv.indexer.domene.EsAnnenErfaring;
...
public class EsCvTransformerTest {
  ...
  public void esCvTransformerShouldConvertCvEventToEsCvWithCorrectYrkeserfaring() {
    ...
    assertThat(yrkeserfaring.get(0).getAlternativStillingstittel())
        .isEqualTo("maskinkjører og maskintransport");
    assertThat(yrkeserfaring.get(0).getOrganisasjonsnummer()).isEqualTo("YRKE_ORGNR");
    assertThat(yrkeserfaring.get(0).getNaceKode()).isEqualTo("YRKE_NACEKODE");
  ...
  public void esCvTransformerShouldConvertCvEventToEsCvWithCorrectSertifikat() {
    ...
    assertThat(sertifikat.get(0).getSertifikatKodeNavn())
        .isEqualTo("Førerkort: Kl. A (tung motorsykkel)");
  ...
  public void esCvTransformerShouldConvertCvEventToEsCvWithCorrectForerkort() {
    ...
    assertThat(Forerkort.get(0).getForerkortKodeKlasse())
        .isEqualTo("Førerkort: Kl. A (tung motorsykkel)");
  ...
  public void esCvTransformerShouldCOnvertCvEventToEsCvWithCorrectSamletKompetanse() {
    ...
    assertThat(samletKompetanse.get(1).getSamletKompetanseTekst())
        .isEqualTo("Førerkort: Kl. A (tung motorsykkel)");
    assertThat(samletKompetanse.get(6).getSamletKompetanseTekst()).isEqualTo("Akseloppretting");
    assertThat(samletKompetanse.get(9).getSamletKompetanseTekst())
        .isEqualTo("Førerkort: Kl. A (tung motorsykkel)");
    assertThat(samletKompetanse.get(13).getSamletKompetanseTekst())
        .isEqualTo("Maskin- og kranførerarbeid");
  }
