...
public class CvEventObjectMother {
  ...
  public static CvEvent giveMeCvEvent() {
    ...
    Sprak sprak = new Sprak("2012-12-01", "Språk kode", "Språk kode tekst",
    ...
    GeografiJobbonsker geografiJobbonsker =
        new GeografiJobbonsker("Geografikode tekst", "GeografiKode");
    ...
    return new CvEvent("01016012345", "OLA", "NORDMANN", "1960-01-01", false, "ARBS",
        "unnasluntrer@mailinator.com", "NO", 1L, null, "", "J", "2016-05-30", "Minvei 1", "", "",
        "0654", "OSLO", "NO", 301, false, "", utdanningsListe, yrkeserfaringsListe, kompetanseList,
