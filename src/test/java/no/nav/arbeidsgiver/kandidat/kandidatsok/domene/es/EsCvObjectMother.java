...
public class EsCvObjectMother {
    ...
    public static EsCv giveMeEsCv() {
        ...
        EsCv esCv = new EsCv(nteAktorId(1), "01016012345", "OLA", "NORDMANN", "1960-01-01", false, "JOBBS",
                ...
                true, false, "LEDIG_NAA", "5001", "H149390", "Olle Svenske", "olle@svenske.se", "Viken", "Lier");
    ...
    public static EsCv giveMeEsCv2() {
        ...
        EsYrkeserfaring yrkeserfaring6 =
                new EsYrkeserfaring(fraIsoDato("2017-10-01"), fraIsoDato("2019-09-26"), "Awesome coders AS", "5746.07",
                        "Javautvikler", Set.of("Javautvikler"), "Javautvikler", "YRKE_ORGNR", "YRKE_NACEKODE", false, Arrays.asList("Javaprogrammerer", "Javawizard", "Javaguru"), "Oslo");
        ...
        EsCv esCv = new EsCv(nteAktorId(2), "05236984567", "KARI", "NORDMANN", fodselsdatoForAlder(39), false, "PARBS",
                ...
                true, true, null, "0401", "H149390", "Olle Svenske", "olle@svenske.se", "Viken", "Lier");
    ...
    public static EsCv giveMeEsCv3() {
        ...
        EsCv esCv = new EsCv(nteAktorId(3), "04265983651", "HANS", "NORDMANN", "1955-11-04", false, "RARBS",
                ...
                true, true, null, "0301", "H149390", "Olle Svenske", "olle@svenske.se", "Viken", "Drammen");
        esCv.addUtdanning(utdanningListe);
        esCv.addYrkeserfaring(yrkeserfaringListe);
        esCv.addKompetanse(kompetanseListe);
        esCv.addSertifikat(esSertifikatListe);
    ...
    public static EsCv giveMeEsCv4() {
        ...
        EsCv esCv = new EsCv(nteAktorId(4), "09568410230", "HANNE", "NORDMANN", "2002-06-04", false, "ARBS",
                ...
                true, true, null, "2021", "H149390", "Olle Svenske", "olle@svenske.se", "Viken", "Oslo");
        esCv.addUtdanning(utdanningListe);
        esCv.addYrkeserfaring(yrkeserfaringListe);
        esCv.addKompetanse(kompetanseListe);
        esCv.addSertifikat(EsSertifikatListe);
    ...
    public static EsCv giveMeEsCv5() {
        ...
        EsYrkeserfaring yrkeserfaring4 =
                new EsYrkeserfaring(fraIsoDato("2005-08-01"), fraIsoDato("2005-09-01"), "K.O. kranservice", "8342.01",
                        "Kranoperatør", Set.of("Kranoperatør"), "Kranoperatør", "YRKE_ORGNR", "YRKE_NACEKODE", false, List.of("Operatør av kran"), "Oslo");
        ...
        EsCv esCv = new EsCv(nteAktorId(5), "03050316895", "BOB", "NORDMANN", "1964-09-01", false, "ARBS",
                ...
                true, true, null, "0219", "H149390", "Olle Svenske", "olle@svenske.se", null, null);
        esCv.addUtdanning(utdanningListe);
        esCv.addYrkeserfaring(yrkeserfaringListe);
        esCv.addKompetanse(kompetanseListe);
        esCv.addSertifikat(EsSertifikatListe);
    ...
    public static EsCv giveMeCvUtenKompetanse() {
        ...
        EsCv esCv = new EsCv(nteAktorId(5), "03050316895", "BOB", "NORDMANN", "1964-09-01", false, "ARBS",
                ...
                true, true, null, "0301", "H149390", "Olle Svenske", "olle@svenske.se", "Viken", "Lier");
        esCv.addUtdanning(utdanningListe);
        esCv.addYrkeserfaring(yrkeserfaringListe);
        esCv.addKompetanse(kompetanseListe);
        esCv.addSertifikat(EsSertifikatListe);
    ...
    public static EsCv giveMeEsCvMedFeil() {
        ...
        EsCv esCv = new EsCv(nteAktorId(1), "02016012345", "OLA", "NORDMANN", "1960-01-01", false, "ARBS",
                ...
                true, true, null, "0301", "H149390", "Olle Svenske", "olle@svenske.se", null, null);
        esCv.addUtdanning(utdanningsListe);
        esCv.addYrkeserfaring(yrkeserfaringsListe);
        esCv.addKompetanse(kompetanseList);
        esCv.addSertifikat(sertifikatListe);
    ...
    public static EsCv giveMeCvForDoedPerson() {
        ...
        EsCv esCv = new EsCv(nteAktorId(7), "01016034215", "OLA", "NORDMANN", "1960-01-01", false, "ARBS",
                ...
                false, false, null, "0301", "H149390", "Olle Svenske", "olle@svenske.se", null, null
        );
        esCv.addUtdanning(utdanningsListe);
        esCv.addYrkeserfaring(yrkeserfaringsListe);
        esCv.addKompetanse(kompetanseList);
    ...
    public static EsCv giveMeCvFritattForAgKandidatsok() {
        ...
        EsCv esCv = new EsCv(nteAktorId(11), "01016034215", "OLA", "NORDMANN", "1960-01-01", false, "ARBS",
                ...
                false, true, null, "0301", "H149390", "Olle Svenske", "olle@svenske.se", null, null);
        esCv.addUtdanning(utdanningsListe);
        esCv.addYrkeserfaring(yrkeserfaringsListe);
        esCv.addKompetanse(kompetanseList);
        esCv.addSertifikat(sertifikatListe);
